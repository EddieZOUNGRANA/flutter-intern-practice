...
class TaskstodoCard extends StatefulWidget {
  const TaskstodoCard({
    super.key,
    required this.todo,
  ...
  @override
  State<TaskstodoCard> createState() => _TaskstodoCard();
}

class _TaskstodoCard extends State<TaskstodoCard> {
